...
def find_backbones(input_file: str) -> Tuple[Optional[list], int]:
    """
    Finds all backbones of the given DIMACS formula from the `input_file`.

    :param input_file: description of the DIMACS formula
    :return: a list of backbones literals in the case that the formula is SAT, none otherwise
    """
...
if __name__ == "__main__":
    ...
    backbones, sat_calls = find_backbones(args.input)
    ...
    print("Number of SAT solver calls =", sat_calls)
